...
REG-007-001|#|CHECK_MONITOR NS 2 NSAfter NA 2 /opt/cavisson/monitors/custom/chm_runtime_changes NA NA NA -f /home/automation/workbench/automation/nscore/lib/RTC_FILES/start.rtc|#|#|#

#Increasing users in RampUp Phase
REG-007-002|#|CHECK_MONITOR NS 3 NSAfter RampUp0 2 /opt/cavisson/monitors/custom/chm_runtime_changes NA NA NA -f /home/automation/workbench/automation/nscore/lib/RTC_FILES/rampup.rtc|#|#|#

#Increasing users in Stablize Phase
REG-007-003|#|CHECK_MONITOR NS 3 NSAfter Stabilize0 2 /opt/cavisson/monitors/custom/chm_runtime_changes NA NA NA -f /home/automation/workbench/automation/nscore/lib/RTC_FILES/stabilize.rtc|#|#|#

#Increasing users in Duration Phase
REG-007-004|#|CHECK_MONITOR NS 3 NSAfter Duration0 2 /opt/cavisson/monitors/custom/chm_runtime_changes NA NA NA -f /home/automation/workbench/automation/nscore/lib/RTC_FILES/duration.rtc|#|#|#

#Increasing users in RampDown Phase
REG-007-005|#|CHECK_MONITOR NS 3 NSAfter RampDown0 2 /opt/cavisson/monitors/custom/chm_runtime_changes NA NA NA -f /home/automation/workbench/automation/nscore/lib/RTC_FILES/rampdown.rtc|#|#|#
