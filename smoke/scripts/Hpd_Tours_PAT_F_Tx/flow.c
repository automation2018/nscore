...
void flow()
{
    ...
    ns_web_url ("login",
        "URL=http://127.0.0.2/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username={PLWT}&password=cavisson&login.x=0&login.y=0&login=Login&JSFormSubmit=off",
        "HEADER=Accept-Language:en-us,en;q=0.5",
