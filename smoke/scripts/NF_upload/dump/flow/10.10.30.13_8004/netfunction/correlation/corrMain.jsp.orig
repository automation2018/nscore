...
<script language="javascript" src="../js/sortableTable.js"></script>
<!----><title>NetFunction (Controller_Proxy) - Edit Service</title></head><body>---&gt;
...
<td>
 <table cellpadding="0" cellspacing="0" width=100%><tr><td>
  ...
  <b> <script> 	genTitle("NetFunction" + " - " +"Edit Service","Edit Service","null"); </script> </b>
...
ul.selectable a.selected{color:#6a9b9c; box-shadow: 5px 0px 5px #888888; }
</style>
...
.halfmoon{margin: 5px 0px -10px 0px;}

.halfmoon ul{padding: 2px 9px 0px 5px;margin-left: 0;margin-top: 1px;
margin-bottom: 0;font: 12px Verdana;list-style-type: none; text-align: left; /*set to left, center, or right to align the menu as desired
...
border-left: 1px solid #DDD; color: black; font-size: 13px; background: #E0eaf7 url(../images/tabright.gif) top right no-repeat; }
...
function check1()
	       {
	            var tabID = document.getElementById('tab_1');
	            var linkID = document.getElementById('someFrame1');
	            linkID.src = "corrAllTemplates.jsp";
	       }
	       
function check2()
	       {
	            var tabID = document.getElementById('tab_2');
	            var linkID = document.getElementById('someFrame1');
	            linkID.src = "corrMain.jsp";
	       }
function check3()
	       {
	            var tabID = document.getElementById('tab_3');
	            var linkID = document.getElementById('someFrame1');
	            linkID.src = "corrServiceMain.jsp";
	       }
</script>
...
<!--[if (gt IE 9)|!(IE)]><!-->  <!--<![endif]-->
	...
	<div id="nav" class="halfmoon">
	<ul class="selectable">
	  <li><a href="#" id="tab_1" onclick="check1();" class="selected">Templates</a></li>
	  <li><a href="#" id="tab_2" onclick="check2();">Parameters</a></li>
	  <li><a href="#" id="tab_3" onclick="check3();">Service Settings</a></li>
	</ul>
	<br style="clear: left;">
	</div>

<div id="dd" style="margin: -6px 0px 0px;">
<iframe name="someFrame1" id="someFrame1" style="border: 1px solid gray; width: 98.5%; height: 490px; padding: 5px; margin: 0px 2px;" src="corrMain.jsp"></iframe>
</div>					
</body></html>