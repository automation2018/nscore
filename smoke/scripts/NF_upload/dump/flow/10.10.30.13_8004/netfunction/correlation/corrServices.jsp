...
</head><body class="yui-skin-sam" onload="onLoadFunction()"><iframe style="position: absolute; visibility: visible; background-color: transparent; border-width: 0pt; width: 2em; height: 2em; left: 0pt; top: -27px;" title="Text Resize Monitor" id="_yuiResizeMonitor"></iframe>
...
<table class="yui-skin-sam" align="center" border="0" cellpadding="0" cellspacing="0" width="100%">

<tbody><tr><td colspan="2" style="height: 8px;"> </td></tr>

<tr>
<td style="background-color: rgb(242, 242, 242); padding-left: 2px;" align="center" width="8%"><img src="../images/logo.png" class="logoSize/"> </td>

<td>
 <table cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td>
  <div style="z-index: 2; position: static; display: block; visibility: visible;" id="productsandservices" class="yuimenubar yuimenubarnav yui-module yui-overlay visible">
    <div class="bd">
      <ul class="first-of-type">
 
         <li index="0" groupindex="0" id="yui-gen0" class="yuimenubaritem  first-of-type"></li>

        <li index="1" groupindex="0" id="yui-gen1" class="yuimenubaritem yuimenubaritem-hassubmenu"><a class="yuimenubaritemlabel yuimenubaritemlabel-hassubmenu" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;">Services</a>
          <div style="z-index: 2; position: absolute; visibility: hidden;" id="corrDesign" class="yuimenu yui-module yui-overlay yui-overlay-hidden">
          <div class="bd">
           <ul>
       ...
       <li index="2" groupindex="0" id="yui-gen2" class="yuimenubaritem yuimenubaritem-hassubmenu"><a class="yuimenubaritemlabel yuimenubaritemlabel-hassubmenu" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;">Data Source</a>
          <div style="z-index: 2; position: absolute; visibility: hidden;" id="corrDataSourceDesign" class="yuimenu yui-module yui-overlay yui-overlay-hidden">
          <div class="bd">
           <ul>
        ...
        <li index="3" groupindex="0" id="yui-gen3" class="yuimenubaritem"><a class="yuimenubaritemlabel" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;" href="../correlation/corrDiagnosis.jsp">Request Trace</a>
        
        
	
        </li><li index="4" groupindex="0" id="yui-gen4" class="yuimenubaritem yuimenubaritem-hassubmenu"><a class="yuimenubaritemlabel yuimenubaritemlabel-hassubmenu" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;">Configuration</a>
          <div style="z-index: 2; position: absolute; visibility: hidden;" id="configurationDesign" class="yuimenu yui-module yui-overlay yui-overlay-hidden">
          <div class="bd">
           <ul>
        ...
        <li index="5" groupindex="0" id="yui-gen5" class="yuimenubaritem"><a class="yuimenubaritemlabel" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;" href="../layouts/index.jsp">Layouts</a>
	</li>
	...
	<li index="6" groupindex="0" id="yui-gen6" class="yuimenubaritem yuimenubaritem-hassubmenu"><a class="yuimenubaritemlabel yuimenubaritemlabel-hassubmenu" style="color: rgb(0, 0, 128); text-decoration: none; font-weight: bolder;">Help</a>

          <div style="z-index: 2; position: absolute; visibility: hidden;" id="help" class="yuimenu yui-module yui-overlay yui-overlay-hidden">
          <div class="bd">
           <ul>
  ...
  <td style="background-color: rgb(242, 242, 242); border-collapse: collapse;">
   <div style="width: 100%; border-bottom: 1px solid rgb(236, 233, 218);"><table width="100%">
  <tbody><tr width="35%" id="MenuHeader" style="color: gray;" align="right"><td>Username: netstorm | <a href="javascript:openLogout()"> Logout</a> | <a href="corrServices.jsp"> Home</a> 
  ...
  </tr><tr><td colspan="2"><table class="screenTitle" align="center" width="100%"><tbody><tr><td width="15%"> </td><td align="center">
  <b> <script> 	genTitle("NetFunction" + " - " +"Services","Services","null"); </script>NetFunction - Services </b>
  </td></tr></tbody></table></td></tr></tbody></table>     
  
</td>
</tr>
<tr color="#F5FAFF"> <td colspan="2" valign="top"><div style="border-top: 1px solid rgb(236, 233, 218); width: 100%;"></div>
</td></tr>
</tbody></table>  
...
<script>showFilterTestRun()</script><table align="center" border="0" width="100%"><tbody><tr><td align="right" width="7%"><font size="1"><b>Filter Services:</b></font></td><td align="right" width="80%"><table class="filterBorder" align="left" border="0" width="100%"><tbody><tr><td width="10%">Service Type  </td><td width="10%"> <select id="ServiceType" name="servicetype"><option value="All" selected="selected">All</option><option value="HTTP">HTTP</option><option value="JDBC">JDBC</option><option value="EJB Call">EJB CALL</option><option value="SPRING REMOTING">SPRING REMOTING</option><option value="Java Class">Java Class</option></select></td><td align="right" width="7%">State </td><td width="10%"> <select id="State" name="state"><option value="All" selected="selected">All</option><option value="disabled">Disabled</option><option value="enabled">Enabled</option></select></td><td align="left" width="5%">Mode </td><td width="10%"> <select id="Mode" name="mode"><option value="All" selected="selected">All</option><option value="Simulate">Simulate</option><option value="Forward">Forward</option><option value="Mixed">Mixed</option></select></td><td align="left" width="3%">&amp;nbspLast Modified </td><td width="10%"> <select id="LastModified" name="Last modified"><option value="0" selected="selected">All</option><option value="1">Last 24hours</option><option value="7">Last 7 days</option><option value="30">Last 30 days</option><option value="180">Last 6 months</option><option value="365">Last 1 year</option></select></td><td align="left" nowrap="nowrap" width="5%"> Keyword </td><td title="Find Services containing keyword." align="left" nowrap="nowrap"><input class="fieldValueOfTextBox" name="txtKeyword" style="width: 100%;" onkeypress="return valEnteredKeyPress(event)" type="text"></td> </tr></tbody></table> </td> <td align="right" width="100%"><table border="0" width="100%"><tbody><tr><td align="right" valign="center" width="25%"><input class="button" style="width: auto;" value="Apply" name="Apply" onclick="clickApply(); " type="Button"></td> <td align="left" nowrap="nowrap" valign="center" width="25%">  <input class="button" style="width: auto;" value="Show All" name="Show All" onclick="showAllUser(); " type="Button"></td></tr></tbody></table></td></tr><tr><td></td></tr></tbody></table>


<script>showServices();</script><table valign="top" align="center" border="0" cellpadding="0" cellspacing="0" width="99%"><tbody><tr><td><table class="scrollbarColorChange" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td class=""></td></tr><tr> <td align="center" valign="top"><table cellpadding="0" cellspacing="0" width="99%"></table><table valign="top" style="font-size: 10px;" align="center" border="0" cellpadding="0" cellspacing="0" width="99%"><tbody><tr><td><div id="ScrollablePane" style="overflow: auto; width: 100%; height: 342.16px; border: 0px solid rgb(223, 233, 247);"><table id="showServiceId" style="table-layout: fixed; border: 1px solid rgb(223, 233, 247);" class="resizable" align="center" border="0" cellpadding="0" cellspacing="0" width="100%"><thead id="pfh"><tr class="tableHeaderLockedEnhance" id="TableHeader"><th class="tableCell" align="left" width="2%"><input name="chkMain" onclick="clickChkMain();" title="Select All" value="" type="checkbox"></th><th class="tableCell" title="Click to sort on Service Name" onclick="getSortData('1');" align="left" nowrap="nowrap" width="20%"><b style="cursor: pointer;">  Service Name <span style="display: none;" id="1"></span></b></th><th class="tableCell" title="Click to sort on Endpoint URL" onclick="getSortData('2');" align="left" nowrap="nowrap" width="31%"><b style="cursor: pointer;">  Endpoint URL <span style="display: none;" id="2"></span></b></th><th class="tableCell" title="Click to sort on Templates" onclick="getSortData('3');" align="right" nowrap="nowrap" width="7%"><b style="cursor: pointer;">  Templates  <span style="display: none;" id="3"></span></b></th><th class="tableCell" onclick="getSortData('12');" title="Click to sort on Last Modified" align="right" nowrap="nowrap" width="10%"><b style="cursor: pointer;">  Last Modified  <span style="display: inline;" id="12"><img src="../images/downArrow.gif"></span></b></th><th class="tableCell" title="Click to sort on Last Updated By" onclick="getSortData('13');" align="left" nowrap="nowrap" width="9%"><b style="cursor: pointer;">  Last Updated By<span style="display: none;" id="13"></span></b></th><th class="tableCell" title="Click to sort on State" onclick="getSortData('14');" align="left" nowrap="nowrap" width="5%"><b style="cursor: pointer;">  State<span style="display: none;" id="14"></span></b></th><th class="tableCell" title="Click to sort on Mode" onclick="getSortData('16');" align="left" nowrap="nowrap" width="5%"><b style="cursor: pointer;">  Mode<span style="display: none;" id="16"></span></b></th><th class="tableCell" title="Click to sort on Service Type" onclick="getSortData('17');" align="left" nowrap="nowrap"><b style="cursor: pointer;">  Service Type<span style="display: none;" id="17"></span></b></th></tr></thead><tbody><tr id="RowId0" class="tableRowEvenNew" onmouseout="outMouseForService(id)" onmouseover="overMouseForService(id)"><td class="tableCell" align="left"><input name="chkRow" value="0" onclick="changeColorOfSelectedRowsByCheckForPaging(0,this,arrSelectedRows,'0');statusSelectionRows(this,0);if(event.shiftKey||event.ctrlKey){shiftCheckForPaging(lastId,0,this,event.shiftKey||event.ctrlKey,shiftLastCheckVaue,arrIndex);}clickChkRow(this,'0');if(event.shiftKey||event.ctrlKey)disableButton(true,true,false,true,false,true,true,true);" type="checkbox"></td><td class="tableCell" align="left" nowrap="nowrap">  <a href="javascript:openTemplateWin('/cavisson.com','default','test','NA')">test</a></td><td class="tableCell" align="left" nowrap="nowrap">  /cavisson.com</td><td class="tableCell" align="right" nowrap="nowrap">  2   </td><td class="tableCell" align="right" nowrap="nowrap">  03/17/2015 12:26  </td><td class="tableCell" align="left" nowrap="nowrap">  netstorm</td><td class="tableCell" align="left" nowrap="nowrap">  enabled</td><td class="tableCell" align="left" nowrap="nowrap">  Simulate</td><td class="tableCell" align="left" nowrap="nowrap">  HTTP</td></tr><tr id="RowId1" class="tableRowOddNew" onmouseout="outMouseForService(id)" onmouseover="overMouseForService(id)"><td class="tableCell" align="left"><input name="chkRow" value="1" onclick="changeColorOfSelectedRowsByCheckForPaging(1,this,arrSelectedRows,'0');statusSelectionRows(this,1);if(event.shiftKey||event.ctrlKey){shiftCheckForPaging(lastId,1,this,event.shiftKey||event.ctrlKey,shiftLastCheckVaue,arrIndex);}clickChkRow(this,'1');if(event.shiftKey||event.ctrlKey)disableButton(true,true,false,true,false,true,true,true);" type="checkbox"></td><td class="tableCell" align="left" nowrap="nowrap">  <a href="javascript:openTemplateWin('/SIXBeanXapiJaxWS/KohlsGetViewPackSlipServiceService','default','KohlsSK','NA')">KohlsSK</a></td><td class="tableCell" align="left" nowrap="nowrap">  /SIXBeanXapiJaxWS/KohlsGetViewPackSlipServiceService</td><td class="tableCell" align="right" nowrap="nowrap">  1   </td><td class="tableCell" align="right" nowrap="nowrap">  03/03/2015 15:26  </td><td class="tableCell" align="left" nowrap="nowrap">  netstorm</td><td class="tableCell" align="left" nowrap="nowrap">  enabled</td><td class="tableCell" align="left" nowrap="nowrap">  Simulate</td><td class="tableCell" align="left" nowrap="nowrap">  HTTP</td></tr><tr id="RowId2" class="tableRowEvenNew" onmouseout="outMouseForService(id)" onmouseover="overMouseForService(id)"><td class="tableCell" align="left"><input name="chkRow" value="2" onclick="changeColorOfSelectedRowsByCheckForPaging(2,this,arrSelectedRows,'0');statusSelectionRows(this,2);if(event.shiftKey||event.ctrlKey){shiftCheckForPaging(lastId,2,this,event.shiftKey||event.ctrlKey,shiftLastCheckVaue,arrIndex);}clickChkRow(this,'2');if(event.shiftKey||event.ctrlKey)disableButton(true,true,false,true,false,true,true,true);" type="checkbox"></td><td class="tableCell" align="left" nowrap="nowrap">  <a href="javascript:openTemplateWin('/TestIndexParamWithRanNum','default','TestService','NA')">TestService</a></td><td class="tableCell" align="left" nowrap="nowrap">  /TestIndexParamWithRanNum</td><td class="tableCell" align="right" nowrap="nowrap">  1   </td><td class="tableCell" align="right" nowrap="nowrap">  03/03/2015 14:30  </td><td class="tableCell" align="left" nowrap="nowrap">  netstorm</td><td class="tableCell" align="left" nowrap="nowrap">  enabled</td><td class="tableCell" align="left" nowrap="nowrap">  Simulate</td><td class="tableCell" align="left" nowrap="nowrap">  HTTP</td></tr></tbody><tbody></tbody></table> </div></td></tr><tr><td align="center" valign="top"><table border="0" width="100%"><tbody><tr><td width="9%"> <img src="../images/Recycle-Bin_e.png" disabled="true" title="No service in recycle bin" style="cursor: pointer;" align="left"> </td><td align="center" width="66%"><input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" value="Edit" name="Edit" title="To edit service" onclick="clickEdit();" type="Button"> <input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" value="Copy" name="Copy" title="To copy service" onclick="clickCopy();" type="Button"> <input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" value="Delete" name="Delete" title="To move selected service(s) in Recycle Bin" onclick="clickDelete();" type="Button"> <input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" value="Test" name="Test" title="To test service" onclick="clickTest();" type="Button"> <input class="button" style="width: 60px;" value="Activate" title="To activate services" name="Activate" onclick="clickActivate();" type="Button"> <input disabled="disabled" class="button" style="width: 100px; color: rgb(174, 160, 191);" value="Export Service" title="To export service(s)" name="ExportService" onclick="clickExportService();" type="Button"> <input class="button" style="width: 100px;" value="Import Service" title="To improt service" name="ImportService" onclick="clickImportService();" type="Button"> <input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" title="To enable service(s) and activate" value="Enable" name="ActiveService" onclick='ActiveInactiveService("active");' type="Button"> <input disabled="disabled" class="button" style="width: 60px; color: rgb(174, 160, 191);" value="Disable" title="To disable service(s) and activate" name="InActiveService" onclick='ActiveInactiveService("inactive");' type="Button"> <input disabled="disabled" class="button" style="width: 100px; color: rgb(174, 160, 191);" value="Version Commit" title="To commit service" name="Commit" onclick="clickCommit();" type="Button"> <input disabled="disabled" class="button" style="width: 100px; display: none; color: rgb(174, 160, 191);" value="Update" name="Update" onclick="clickUpdate();" type="Button"> <input disabled="disabled" class="button" style="width: 75px; color: rgb(174, 160, 191);" value="Version Log" name="Log" title="To check version log of service" onclick="clickLog();" type="Button"> <input disabled="disabled" class="button" style="width: 90px; color: rgb(174, 160, 191);" value="Forward Mode" title="To change forward mode and activate" name="ForwardMode" onclick='changeMode("Forward");' type="Button"> <input disabled="disabled" class="button" style="width: 90px; color: rgb(174, 160, 191);" value="Simulate Mode" name="SimulateMode" to="" change="" simulate="" mode="" and="" activate="" onclick='changeMode("Simulate");' type="Button">  </td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table></td></tr><tr><td><table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="font-size: 9px; color: rgb(59, 73, 144); font-weight: bold; text-align: left;" align="left" width="50%">Controller Controller_Proxy is running on IP ALL and port(s) 9020 activated on 03/25/2015 13:17:58</td><td><table border="0" cellpadding="0" cellspacing="0" width="100%%"><tbody><tr><td align="right"> </td></tr></tbody></table></td><td width="16%"><table align="right" border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="font-size: 9px; color: rgb(59, 73, 144); font-weight: bold;" align="right">Show all services on same page <input name="chkShowPagination" value="1" onclick="showAllServiceInSamePage()" type="checkbox">  </td></tr></tbody></table></td></tr></tbody></table></td></tr></tbody></table>
...
<tbody><tr><td>Copyright © 2014, Cavisson Systems Inc. All rights reserved.
</td>
...
<div id="frmchild" style="display: none;">
  <div class="bd">
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
      <tbody><tr align="center"><td id="Label" nowrap="nowrap">
      </td></tr><tr>
         <td align="center" valign="top" width="45%">
           <table border="0" cellpadding="0" cellspacing="5" width="95%">
             ...
             <tr align="center"> <td class="fieldLableRight">
                 New Service Name   
                <input class="fieldValueOfTextBox" maxlength="90" onkeypress="return valEnteredKeyNoSpace(event)" id="txtService" name="txtService" size="90%" style="width: 60%;" type="text">
             </td> </tr>
             <tr><td> </td></tr>

             <tr align="center"><td class="fieldLableRight">
                       New URL  
                 <input class="fieldValueOfTextBox" onkeypress="return valEnteredKeyNoSpace(event)" maxlength="90" id="txtUrl" name="txtUrl" size="90%" style="width: 60%;" type="text">
             </td></tr> 
            <tr><td> </td></tr></tbody></table>
         
         </td></tr><tr><td>
           <table width="65%"><tbody><tr align="center"><td align="right">  
              <input tabindex="3" value="    OK    " onclick="clickOk();" type="Button">   
              <input tabindex="4" value="Cancel" onclick="cancelSceForm();" type="Button">
             </td></tr></tbody></table>
            </td></tr>
...
<div id="frmchild1" style="display: none;">
		...
		<table class="table" cellpadding="0" cellspacing="0" width="98%">
			...
			<tr>
				<td align="center" valign="top">
					<br>  
						<table border="0" cellpadding="0" cellspacing="0" width="95%"><tbody><tr>
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tbody><tr>
										<td class="fieldLableOnColor" width="20%">Service Name </td>
										<td align="left" valign="middle">
											<input class="valueOfTextBox" id="txtServiceNameEdit" name="txtServiceNameEdit" onkeypress="return valEnteredKeyNoSpace(event)" style="width: 75%;" value="" title="Service Name" type="text"> 
										</td>
									</tr>
								</tbody></table>
							</td>
						...
						<tr>
							<td>
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
									<tbody><tr>
										<td class="fieldLableOnColor" width="20%">URL </td>
										<td align="left" valign="middle">
											<input class="valueOfTextBox" id="txtURLEdit" name="txtURLEdit" onkeypress="return valEnteredKeyNoSpace(event)" style="width: 75%;" title="URL" value="" type="text">   
										</td>
									</tr>
								</tbody></table>
							</td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody><tr>
				...
				<td align="right" valign="middle" width="2%">
					<input id="chkRegx" name="chkRegx" value="1" onclick="changeIgnoreCase()" title="Regular Expression" type="checkbox">
				</td>     
				<td class="fieldLable" align="left" width="25%">Regular Expression
					<a onclick="openWin('RegularINFO','700')"><img src="../images/question.png"></a>
				</td>      
				<td align="right" valign="middle" width="2%">
					<input id="chkURLIgnoreCase" name="chkURLIgnoreCase" value="1" title="URL Ignore Case" type="checkbox">
				</td>      
				<td class="fieldLable" align="left" width="20%">Ignore Case
				</td>          
				<td align="right" valign="middle" width="2%">
					<input id="chkCompleteMatch" name="chkCompleteMatch" value="1" title="Complete Match" type="checkbox">
				</td>      
				<td class="fieldLable" align="left">Complete Match
				</td>
			</tr>
		</tbody></table>
	</td>
  ...
  <tr><td> </td></tr>
	...
	<tbody><tr>
		<td align="center" valign="top">  
			<input class="button" style="width: 60px;" value="OK" name="OK" onclick="clickOKEdit()" type="Button">  
			<input class="button" style="width: 60px;" value="Cancel" name="Cancel" onclick="cancelSceFormEdit()" type="Button">   
		</td>
	</tr>
  </tbody></table>
  <table>
  <tbody><tr><td><b>Note: After edit service, service will not be activate, user need to Activate.</b></td></tr>
  </tbody></table>
  </td></tr></tbody></table>
