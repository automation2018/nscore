...
int post_call_back()
{
    char *ptr = "http://10.10.30.38/PostCallBack/PostCallBack_var.html";
    ns_set_embd_objects(1, &ptr, 1);
    printf("\n In side redirection callback to trace redirection depth \n");
}
...
void flow()
{
    ...
    ns_web_url ("index1",
        "URL=http://10.10.30.38/PostCallBack/PostCallBack_WithRedirection.html",
        "PostURLCallback:3=post_call_back",
    );
...
/*
    ...
    ns_web_url ("index2",
        "URL=http://10.10.30.38/page2.html",
    ...
    ns_web_url ("index3",
        "URL=http://10.10.30.38/ashish.html",
         //"URL=http://10.10.70.3:9002/req",
         "POSTURLCALLBACK:2=hie",
     );
    ns_start_transaction("Transaction_3");
