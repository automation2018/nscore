...
double custom_delay(){
	static double Scan_Item_Time[4] = {1.0,2.0,0.5,10.0};
	int random_index = ns_get_random_number_int(0,3);
	printf("\n********random index is :  ****************** %d \n", random_index);
	double Delay_time = Scan_Item_Time[random_index];
	printf("\n********Random Delay Time ****************** %f \n",Delay_time);
	return Delay_time;
}
