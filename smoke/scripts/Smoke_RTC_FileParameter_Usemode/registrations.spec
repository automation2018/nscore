...
nsl_static_var(user:1,pass:2, File=param3, Refresh=USE, Mode=SEQUENTIAL, EncodeMode=All);
...
//nsl_static_var(user:1,pass:2, File=param3, Refresh=SESSION, Mode=USE_ONCE, EncodeMode=All, OnUseOnceError=ABORTSESSION);
