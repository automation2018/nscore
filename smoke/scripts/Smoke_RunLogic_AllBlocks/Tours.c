/*-----------------------------------------------------------------------------
    ...
    Date of recording: 7/1/2011 11:23:9
    Flow details:
...
void Tours()
{
    ns_start_transaction("TxnToursFlow");
    ...
    ns_web_url ("login_4",
        "URL=http://127.0.0.1/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=sauabh&password=cavisson&JSFormSubmit=off&login.x=47&login.y=3",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_web_url ("findflight_3",
        "URL=http://127.0.0.1/cgi-bin/findflight?depart=Acapulco&departDate=07-02-2011&arrive=Acapulco&returnDate=07-03-2011&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=67&findFlights.y=14",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_web_url ("findflight_5",
        "URL=http://127.0.0.1/cgi-bin/findflight?firstName=Tiger&lastName=Scott&address1=4261+Stevenson+Blvd.&address2=Fremont%2C+CA+94538&pass1=Scott+Tiger&creditCard=&expDate=&oldCCOption=&numPassengers=1&seatType=Coach&seatPref=None&outboundFlight=000%7C0%7C07-02-2011&advanceDiscount=&.cgifields=saveCC&buyFlights.x=103&buyFlights.y=10",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
...
ns_end_transaction("TxnToursFlow", NS_AUTO_STATUS);
