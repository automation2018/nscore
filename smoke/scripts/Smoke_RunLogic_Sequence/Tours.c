/*-----------------------------------------------------------------------------
    ...
    Date of recording: 7/14/2011 0:18:1
    Flow details:
...
void Tours()
{
    ns_start_transaction("TxnTours");
    ns_web_url ("index_html_4",
    ...
    ns_web_url ("login_4",
        "URL=http://127.0.0.1/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=saurabh&password=cavisson&JSFormSubmit=off&login.x=55&login.y=11",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_web_url ("findflight_4",
        "URL=http://127.0.0.1/cgi-bin/findflight?depart=Acapulco&departDate=07-15-2011&arrive=Acapulco&returnDate=07-16-2011&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=56&findFlights.y=8",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_page_think_time(0.031);
    ns_end_transaction("TxnTours", NS_AUTO_STATUS);
}
