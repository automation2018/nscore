/*-----------------------------------------------------------------------------
    ...
    Date of recording: 7/5/2011 5:29:55
    Flow details:
...
void Tours()
{
    ...
    ns_web_url ("login_4",
        "URL=http://127.0.0.1/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=saurabh&password=cavisson&JSFormSubmit=off&login.x=48&login.y=16",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_web_url ("findflight_4",
        "URL=http://127.0.0.1/cgi-bin/findflight?depart=Acapulco&departDate=07-06-2011&arrive=Acapulco&returnDate=07-07-2011&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=42&findFlights.y=7",
        "HEADER=Accept-Language: en-US",
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", "HEADER=Accept-Language: en-US", END_INLINE,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/sun_swede.gif", "HEADER=Accept-Language: en-US", END_INLINE,
    ...
    ns_end_transaction("TxnReservation", NS_AUTO_STATUS);
}
