...
void flow()
{
   ...
   ns_web_url ("index",
     //   "URL=http://127.0.0.1/tours/index.html",
      //   "URL=http://10.10.30.30/book.xml",
         "URL=http://10.10.30.96/product.json",
   ...
   ns_start_transaction("login");
    ...
    ns_web_url ("login",
        ...
        "HEADER=Accept-Language:en-us,en;q=0.5; json_para={jsonpara}",
  ...
  ns_web_url ("reservation",
        ...
        "HEADER=Accept-Language:en-us,en;q=0.5; json_para={jsonpara2}",
