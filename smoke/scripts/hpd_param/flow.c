...
//   ns_save_string("6","number");
    ns_save_string("1", "decindex");
    ns_save_string("Second_index","decarray_2");
    ns_save_string("Third_index","decarray_3");
    ...
    ns_web_url ("index",
	    ...
	    "BODY= Declare variable is {dec}...Declare Array value is{decarray_0}...{decarray_1} ......{decarray_2}..........{decarray_3}",
