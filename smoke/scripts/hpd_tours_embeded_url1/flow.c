...
void flow()
{
   ns_start_transaction("IndexPage_1");
    ns_web_url ("index_1",
       // "URL=http://127.0.0.1/tours/index.html",
         "URL=http://10.10.30.96/tours/fail_some_embedded.html",
        ...
        INLINE_URLS,
            ...
            "URL=http://12.0.0.1/tours1/Merc10-dev", "HEADER=Accept-Language:en-us,en;q=0.5", END_INLINE,
    ...
    ns_end_transaction("IndexPage_1", NS_AUTO_STATUS);
    
   ns_start_transaction("login_1");
    ns_web_url ("login_1",
  ...
  ns_end_transaction("login_1", NS_AUTO_STATUS);
   
  ns_start_transaction("Reservation_1");
  
  ns_web_url ("reservation_1",
    ...
    ns_end_transaction("Reservation_1", NS_AUTO_STATUS);
   

    ns_start_transaction("FindFlight_1");
    ns_web_url ("findflight_1",
    ...
    ns_end_transaction("FindFlight_1", NS_AUTO_STATUS);
    
    ns_start_transaction("FindFlight2_1");
    ns_web_url ("findflight_2_1",
    ...
    ns_page_think_time(20);
    ns_end_transaction("FindFlight2_1", NS_AUTO_STATUS);
    
    ns_start_transaction("FindFlight3_1");
    ns_web_url ("findflight_3_1",
    ...
    ns_end_transaction("FindFlight3_1", NS_AUTO_STATUS);
    
    ns_start_transaction("Welcome_1");
    ns_web_url ("welcome_1",
    ...
    ns_end_transaction("Welcome_1", NS_AUTO_STATUS);
   ns_page_think_time(20);
}
