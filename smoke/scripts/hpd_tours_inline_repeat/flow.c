...
void flow()
{
   ns_start_transaction("IndexPage");
    ns_web_url ("index",
        ...
        INLINE_URLS,
            "URL=http://127.0.0.1/tours/Merc10-dev/images/banner_animated.gif", %ApiValue,"HEADER=Accept-Language:en-us,en;q=0.5", END_INLINE,
            ...
            "URL=http://127.0.0.1/tours/images/banner_merctur.jpg","REPEAT=3", "HEADER=Accept-Language:en-us,en;q=0.5", END_INLINE
    );
