...
SMOKE-003-001|OneMain_4Resp|1|1|1|0|100|#|#|#|#|#|SERVER_HOST 127.0.0.1 192.168.255.2 -
SMOKE-003-002|OneMain_4Resp|1|1|0|0|0|#|#|#|#|#|SERVER_HOST 127.0.0.1 192.168.255.2 -
SMOKE-003-003|OneMain_4Resp_2Embd|1|1|1|0|0|#|#|#|#|#|SERVER_HOST 127.0.0.1 192.168.255.2 -
SMOKE-003-004|OneMain_4Resp_2Embd|1|1|0|0|100|#|#|#|#|#|SERVER_HOST 127.0.0.1 192.168.255.2 -
#
#Cases for include/exclude domain/url which works along with AUTOFETCH and MAX_DYNAMIC_HOST keyword
SMOKE-003-005|AutoFetchDomainUrl|1|1|1|0|100|MAX_DYNAMIC_HOST 2|G_INLINE_INCLUDE_DOMAIN_PATTERN ALL 10.10.30.38|#|#|#|#
...
#
#Cases for PostCallBack Api usages;Issue was in Kohls Client;When JS requests again requests for JSP requests NS engine unable
#to handale the situation with autofetch feature; so PostURLCallback is intorduced to list additional requests
