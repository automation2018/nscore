$TestDescription|$SESSIONS|$SESSION_MODE|$KeyWord_Values|$SCRIPT1|$SCRIPT2
# HTTP REFERER 
...
SMOKE-034-002|1|0|ALL 0 1|http_referer1 1|#
...
SMOKE-034-005|1|0|ALL 0 1|http_referer1 1|#
#Test case ID - NS_REFERER_011
SMOKE-034-006|1|0|ALL 1 0|http_referer1 1|#
#Test case ID - NS_REFERER_015
SMOKE-034-007|2|1|ALL 1 0|http_referer1 1|#


# Functional test cases without redirection
#Test case ID - NS_REFERER_023
SMOKE-034-008|2|1|ALL 1 0|http_referer2 1|#
#Test case ID - NS_REFERER_024
SMOKE-034-009|2|1|ALL 1 1|http_referer2 1|#


# Functional test cases with group wise
#Test case ID - NS_REFERER_026
SMOKE-034-010|2|0|G1 0 1|http_referer1 1|SGRP G2 NA Internet 0 http_referer2 1
#Test case ID - NS_REFERER_027
SMOKE-034-011|2|0|G1 1 0|http_referer1 1|SGRP G2 NA Internet 0 http_referer2 1
#Test case ID - NS_REFERER_028
SMOKE-034-012|2|0|G1 1 1|http_referer1 1|SGRP G2 NA Internet 0 http_referer2 1


# Functional Test cases with linking
# Linking from HTTP to HTTP (#Test case ID - NS_REFERER_038)
SMOKE-034-013|1|0|ALL 1 0|http_linking 1|#
# Linking from HTTP to HTTPS (#Test case ID - NS_REFERER_039)
SMOKE-034-014|1|0|ALL 1 0|http_linking 1|#
# Linking from HTTPS to HTTPS (#Test case ID - NS_REFERER_040)
SMOKE-034-015|1|0|ALL 1 0|http_linking 1|#
# Linking from HTTPS to HTTP (#Test case ID - NS_REFERER_041)
SMOKE-034-016|1|0|ALL 1 0|http_linking 1|#
