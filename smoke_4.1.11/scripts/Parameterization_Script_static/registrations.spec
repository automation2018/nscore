...
//
//nsl_static_var(UnameFP:1,UpassFP:2, File=LoginData, Refresh=%Ord, Mode=%Rb, FirstDataLine=2, EncodeMode=All);
...
nsl_random_number_var(PassengernoRN, Max=10, Format=%01lu, Refresh=%Ord);
