...
//
//nsl_static_var(UnameFP:1,UpassFP:2, File=LoginData, Refresh=SESSION, Mode=SEQUENTIAL, FirstDataLine=2, EncodeMode=All);
...
nsl_unique_number_var(CreditcardUN, Format=%09lu, Refresh=%REFRESH_MODE);
//nsl_random_number_var(PassengernoRN, Max=10, Format=%01lu, Refresh=SESSION);
