/*-----------------------------------------------------------------------------
    ...
    Name: flow
    Recorded By: vishal choudhury
    Date of recording: 25/01/2017 02:51:06
    Flow details:
...
void flow()
{
   ...
   ns_start_transaction("login");
    ns_web_url ("login",
        "URL=http://127.0.0.1/cgi-bin/login1?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=netstorm&password=cavisson&login.x=0&login.y=0&login=Login&JSFormSubmit=off",
        "HEADER=Accept-Language:en-us,en;q=0.5",
  ...
  ns_web_url ("reservation",
    ...
    ns_web_url ("welcome",
       // "URL=http://127.0.0.1/cgi-bin/welcome",
        ...
        "URL=http://127.0.0.1/custom/samples/response_line/test_404.html",
        "HEADER=Accept-Language:en-us,en;q=0.5",
