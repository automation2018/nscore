$TestDescription|$ScriptName|$User|$Sessions|$Mode|$EmbMode|$KAPct|$DYNAMIC_HOST|$INCLUDE_DOMAIN|$EXCLUDE_DOMAIN|$INCLUDE_URL|$EXCLUDE_URL|$G_SERVER_HOST
# Autofetch general cases
SMOKE-003-001|OneMain_4Resp|1|1|1|0|100|#|#|#|#|#|G_SERVER_HOST ALL 127.0.0.1 10.10.30.96 -
SMOKE-003-002|OneMain_4Resp|1|1|0|0|0|#|#|#|#|#|G_SERVER_HOST ALL 127.0.0.1 10.10.30.96 -
SMOKE-003-003|OneMain_4Resp_2Embd|1|1|1|0|0|#|#|#|#|#|G_SERVER_HOST ALL 127.0.0.1 10.10.30.96 -
SMOKE-003-004|OneMain_4Resp_2Embd|1|1|0|0|100|#|#|#|#|#|G_SERVER_HOST ALL 127.0.0.1 10.10.30.96 -
#
